...
function DockItem({ children, className, onClick }: DockItemProps) {
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={cn(
        'relative inline-flex flex-col items-center justify-center cursor-pointer gap-4',
        className
      )}
      tabIndex={0}
      role='button'
...
function DockLabel({ children, className, alwaysVisible = false, ...rest }: DockLabelProps) {
