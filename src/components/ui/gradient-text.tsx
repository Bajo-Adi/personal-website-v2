...
export function GradientText({
  ...
  return (
    <div
      className={cn(
        "relative mx-auto flex w-full flex-row items-center justify-center",
    ...
    >
      ...
      <div
        className="inline-block relative z-2 text-transparent bg-cover animate-gradient whitespace-nowrap"
        style={{
          ...gradientStyle,
          backgroundClip: "text",
